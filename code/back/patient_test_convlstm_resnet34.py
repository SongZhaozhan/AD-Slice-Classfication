...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'convlstm-resnet34-patient', help='net type')
    ...
    parser.add_argument('-data_root', type=str, default='./data/2D_patient', help='data path root')
    parser.add_argument('-weights', type=str, default='./model/convlstm_resnet34.pth', help='the weights file you want to test')
    ...
    net = ConvLSTMFC(1,1,[32,32,64],[(3,3),(3,3),(3,3)],3,True,True,False)
    ...
    plt.savefig('resnet34.png', pad_inches = 0.2, bbox_inches = 'tight',dpi=800)
