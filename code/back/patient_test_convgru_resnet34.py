...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'resnet18-convlstm-patient', help='net type')
    ...
    net = ConvGRUResNet(1,(96,96),1,[16],[(3,3)],1,torch.cuda.FloatTensor,True,True,False)
