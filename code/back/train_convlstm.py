...
from network.convlstm import ConvLSTMFC
...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'convlstm_resnet34', help='net type')
    parser.add_argument('-gpus', type=list, default=[0,1,2,3], help='use gpu ')
    parser.add_argument('-batch_size', type=int, default=320, help='batch size for dataloader')
    parser.add_argument('-warm', type=int, default=1, help='warm up training phase')
    parser.add_argument('-lr', type=float, default=0.01, help='initial learning rate')
    parser.add_argument('-resume', action='store_true', default=False, help='resume training')
    parser.add_argument('-data_root', type=str, default='./data/2D_seq/', help='data path root')
    parser.add_argument('-epoch', type=int, default= 300, help='the epoch num')
    ...
    net = ConvLSTMFC(1,1,[8],[(3,3)],1,True,True,False)
