...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'resnet34-biconvgru-patient', help='net type')
    ...
    parser.add_argument('-data_root', type=str, default='./data/2D_patient_seq', help='data path root')
    parser.add_argument('-weights', type=str, default='./model/resnet34_biconvgru.pth', help='the weights file you want to test')
    ...
    net = ResNetBiConvGRU(1,(12,12),512,[512],[(3,3)],1,torch.cuda.FloatTensor,True,True,False)
