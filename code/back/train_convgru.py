...
from network.convgru import ConvGRUResNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'convgru_resnet34', help='net type')
    ...
    net = ConvGRUResNet(1,(96,96),1,[32],[(3,3)],1,torch.cuda.FloatTensor,True,True,False)
