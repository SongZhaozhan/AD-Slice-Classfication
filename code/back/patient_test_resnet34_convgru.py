...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'resnet34-convgru-patient', help='net type')
    ...
    parser.add_argument('-weights', type=str, default='./model/resnet34_convgru.pth', help='the weights file you want to test')
