...
from network.biconvgru import Res18BiConvGRU
...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'resnet18_biconvgru-nobg', help='net type')
    ...
    parser.add_argument('-data_root', type=str, default='./data/2D_seq5_s5_nobg-3-10/', help='data path root')
