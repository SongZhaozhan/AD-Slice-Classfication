...
from dataset.dataset_paient import Arotacls_seq
...
if __name__ == '__main__':
    ...
    parser.add_argument('-net', type=str, default= 'resnet18-biconvgru-patient-nobg', help='net type')
    ...
    parser.add_argument('-data_root', type=str, default='./data/patient/2D_seq5_s5_nobg/test/AN_90/', help='data path root')
